...
Route::apiResource('/accepts', 'AcceptController')->middleware('auth:api');
Route::apiResource('/procurements', 'ProcurementController')->middleware('auth:api');
Route::apiResource('/procurementcats', 'ProcurementcatController')->middleware('auth:api');
...
Route::get('/user_sales', 'UserController@user_sales')->middleware('auth:api');
